...
void variaveis_painel_trens(){
  ...
  trens[0].textura.loadFromFile("trem_verde.png");
  trens[1].textura.loadFromFile("trem_rosa.png");
  trens[2].textura.loadFromFile("trem_vermelho.png");
  trens[3].textura.loadFromFile("trem_azul.png");
  for(int i=0;i<4;i++){
